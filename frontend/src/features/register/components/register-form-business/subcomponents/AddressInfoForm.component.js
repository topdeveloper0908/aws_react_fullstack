...
export const AddressInfoForm = ({ parentFormData, setParentPage }) => {
  ...
  console.log("AddressInfoformData", formData);
  ...
  // const formatAsCellNum = (phoneNum) => {
  //   let num = phoneNum.replace(/\D/g, "");
  ...
  //   return cell.replace(/\D/g, "").length === 10;
  // };
    ...
    <div className={styles.container}>
      ...
      <div className="formRow">
        ...
        <div className="labelInputGroup">
          ...
          <br />
          <small className={styles.errorMessageSmall}>{stateError}</small>
        </div>
        <div className="labelInputGroup">
          ...
          />
          <br />
          <small className={styles.errorMessageSmall}>{zipError}</small>
        </div>
      </div>
      <div className="formRow">
        <div className="labelInputGroup">

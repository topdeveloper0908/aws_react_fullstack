...
import styles from "./terms-and-conditions-screen.module.css";

export const TermsAndConditionsScreen = () => {
  return (
    <>
      <span id="terms-and-conditions-header"></span>
      <div className={styles.termsAndConditionsScreen} >
        <div className={styles.innerContainer}>
          <h1>Terms & Conditions</h1>
          <p>
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and CreativeU, LLC (“Company,” “we,” “us,” or “our”), concerning
            your access to and use of the CreativeU.live website as well as any
          ...
          <p>
            Unless otherwise indicated, the Site in our proprietary property and
          ...
          <p>
            ...
            of Use; (4) you are not a minor in the jurisdiction which you
          ...
          <p>
            ...
            or change a user-name you select if we determine, in our sole
            discretion, that such user-name is inappropriate, obscene, or
          ...
          <ol>
            ...
            <li>
              ...
              user-names and/or email addresses of users by electronic or other
            ...
            <li>
              ...
              use of the Site and/or Content contained therein.
            </li>
            ...
            <li>
              Attempt to impersonate another use or person or use the user-name
              of another user.
            </li>
            ...
            <li>
              Attempt to bypass any measure of the Site designed to prevent or
            ...
            <li>
              ...
              “spy-ware” or “passive collection mechanisms” or “pcms”).
            </li>
            <li>
          ...
          <p>
            ...
            blogs, message boards, on-line forums, and other functionality, and
            ...
            any Contributions you transmit maybe treated as non-confidential and
            non-proprietary. When you create or make available any
            Contributions, you thereby represent and warrant that:
          </p>
          <ol>
            <li>
              The creation, distribution, transmission, pubic display, or
              performance, and the accessing downloading, or copying of your
              contributions do no and will not infringe the proprietary rights,
            ...
            <li>
              ...
              people under the age of 18 in a sexual and violent manner.
            </li>
            <li>
          ...
          <p>
            By posting our Contributions to any part of the Site, you
          ...
          <p>
            ...
            Site; and (3) to early screen or delete any Contributions at any
          ...
          <p>
            ...
            investigated, monitored, or check for accuracy, appropriateness or
            ...
            any Third-Party Content does not imply approval or endorsement there
            of by us. If you decide to leave the Site and access the Third-Party
          ...
          <p>
            ...
            the law of these Terms of Use, including without limitation,
            reporting such user(s) to law enforcement authorities; (3) in our
          ...
          <p>
            ...
            hosted in the United States. If you access the Site from the
            European Union, Asia, or any other region of the world with laws of
            ...
            accordance with the U.S. Children’s On-line Privacy Protection Act,
          ...
          <p>
            ...
            you make material misrepresentations in a Notification. This, if you
          ...
          <p>
            ...
            County of Orange applicable to agreements made and to be entirely
          ...
          <p>
            ...
            USA County, California, County of Orange, the Parties hereby consent
            ...
            Convention on Contracts for the International Sale of Good and the
            Uniform Computer Information Transaction Act (UCITA) are excluded
            from these Terms of Use. In no event shall any claim, action, or
            proceeding brought by either Party related in any way to the Site be
            commenced more than one (1) year after the case of action arose.
          </p>
          <h3>CORRECTIONS</h3>
          <p>
          ...
          <p>
            ...
            THIRD PARTY THROUGH THE SITE, ANY HYPER-LINKED WEBSITE, OR ANY
          ...
          <p>
            ...
            AND YOU HAVE ADDITIONAL RIGHTS.
          </p>
          ...
          <p>
            ...
            exclusive defense of such claims. We will use reasonable efforts to
          ...
          <p>
            Visiting the Site, sending us emails, and completing on-line forms
          ...
          <p>
            ...
            provision or part of the provision is deemed revocable from these
            Terms of Use and does not affect the validity and enforceability of
            any remaining provision. There is no joint venture, partnership,
          ...
          <p>
            ...
            <a href="mailto:info@CreativeU.live" className={styles.link}>
              info@CreativeU.live.
            </a>
          </p>
        </div>
